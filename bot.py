...
BOT_TOKEN = os.getenv("8496835608:AAE3zLT_eTVJiGihsQyCYicK5MaOXvGmhE8")
MONGODB_URI = os.getenv("mongodb+srv://rohitchaudhary11052010_db_user:a7zwuvVlxosiZ08W@cluster0.xr49sez.mongodb.net/?appName=Cluster0")
DATABASE_NAME = os.getenv("DATABASE_NAME", "attack_bot")
API_URL = os.getenv("API_URL")
API_KEY = os.getenv("API_KEY")
ADMIN_IDS = [int(id.strip()) for id in os.getenv("ADMIN_IDS", "8591001402").split(",")]
...
class Database:
    def __init__(self):
        self.client = MongoClient(mongodb+srv://rohitchaudhary11052010_db_user:a7zwuvVlxosiZ08W@cluster0.xr49sez.mongodb.net/?appName=Cluster0)
...
def main():
    ...
    application = Application.builder().token("8496835608:AAE3zLT_eTVJiGihsQyCYicK5MaOXvGmhE8").build()
    try:
